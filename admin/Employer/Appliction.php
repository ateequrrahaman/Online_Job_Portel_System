...
<?php $con=mysqli_connect("localhost","root","Atsql@801","job") ?>
<?php
if (!function_exists("GetSQLValueString")) {
  function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "")
  {
      ...
      $theValue = isset($con) ? mysqli_real_escape_string($con, $theValue) : "";
...
do {  
?>
                          <option value="<?php echo isset($row_Recordset1['JobId']) ? $row_Recordset1['JobId'] : ''; ?>"><?php echo isset($row_Recordset1['JobTitle']) ? $row_Recordset1['JobTitle'] : ''; ?></option>
